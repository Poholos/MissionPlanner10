...
Usage:
  ...
  gen-manifest.py <publish_dir> <version> <notes_url> <out.json> \
      ...
      Full-bundle mode: manifest carries a single SHA-256-pinned package; files[] is emitted empty
      so per-file diffing is skipped. macOS supplies a signed+notarized .app archive that the client
      swaps whole, because overwriting loose files would break its seal/staple.
