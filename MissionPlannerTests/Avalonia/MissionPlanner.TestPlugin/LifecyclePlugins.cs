using System;
using System.IO;
using MissionPlanner.TestPlugin.Dependency;
using PortablePlugin = MissionPlanner.Plugin.Plugin;

namespace MissionPlanner.TestPlugin;

public sealed class LifecyclePlugin : PortablePlugin {
...
public sealed class FaultingLoopPlugin : PortablePlugin {
...
public sealed class DecliningPlugin : PortablePlugin {
...
public sealed class BlockingConditionalPlugin : PortablePlugin {
