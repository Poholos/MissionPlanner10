...
public class FaceMapTests {
  ...
  public void Native_face_map_view_constructs_with_compiled_bindings() {
    ...
    Assert.NotNull(view.FindControl<MissionPlanner.Controls.FaceMapPreviewMap>(
        "PreviewMap"));
  ...
  public void Planner_auto_wp_menu_exposes_face_map() {
    ...
    var map = Assert.IsType<MissionPlanner.Controls.FlightPlannerMap>(
        view.FindControl<MissionPlanner.Controls.FlightPlannerMap>("Map"));
