...
public class SurveyGridPreviewTests {
  ...
  public void View_model_defaults_match_upstream_and_point_start_selects_boundary_vertex() {
    ...
    vm.StartFrom = MissionPlanner.Utilities.Grid.StartPosition.Point.ToString();

    Assert.Equal(polygon[1].Lat, MissionPlanner.Utilities.Grid.StartPointLatLngAlt.Lat, 8);
    Assert.Equal(polygon[1].Lng, MissionPlanner.Utilities.Grid.StartPointLatLngAlt.Lng, 8);
  }
