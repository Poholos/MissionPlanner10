...
public class VideoPopupWindow : Window {
  ...
  public VideoPopupWindow(VideoControl video, FlightDataViewModel viewModel) {
    ...
    Avalonia.Controls.Grid.SetRow(video, 0);
    ...
    Avalonia.Controls.Grid.SetRow(commands, 1);
    ...
    Avalonia.Controls.Grid.SetRow(settings, 2);
    ...
    Avalonia.Controls.Grid.SetRow(combinedStatus, 3);
