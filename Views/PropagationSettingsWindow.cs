...
public sealed class PropagationSettingsWindow : Window {
  ...
  public PropagationSettingsWindow() {
    ...
    var parameters = new Avalonia.Controls.Grid {
  ...
  private static void AddRow(Avalonia.Controls.Grid grid, int row, string label, Control control) {
    var text = new TextBlock {
      Text = label,
      VerticalAlignment = VerticalAlignment.Center,
    };
    Avalonia.Controls.Grid.SetRow(text, row);
    Avalonia.Controls.Grid.SetColumn(text, 0);
    grid.Children.Add(text);
    Avalonia.Controls.Grid.SetRow(control, row);
    Avalonia.Controls.Grid.SetColumn(control, 1);
